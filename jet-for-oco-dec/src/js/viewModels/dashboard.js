 ...
 */
define(['ojs/ojcore', 'knockout', 'jquery', 'appController', 'mobe', 'ojs/ojknockout', 'ojs/ojinputtext', 'ojs/ojlabel'],
...
self.isLoggedIn = ko.observable(false);
  ...
  self.username = ko.observable("luc.bors@eproseed.com");
  ...
  self.login = function () {
      mobe.authenticate(self.username(), self.password(), self.loginSuccess, self.loginFailure);
  };
